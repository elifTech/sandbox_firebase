export {PagincationService};

PagincationService.$name = 'PagincationService';
PagincationService.$inject = ['$rootScope', '$firebaseAuth'];
function PagincationService($rootScope, $firebaseAuth) {
  Paginator.prototype = {
    nextPage: function (callback) {
      if( this.isLastPage() ) {
        ...
        this.ref.startAt(pri, lastKey)
          .limitToLast(this.limit + (lastKey? 1 : 0))
